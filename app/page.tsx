...
const features = [
  ...
  },
  {
    id: 5,
    name: "Cloud Backup",
    description: "Rest assured knowing your documents are safely backed up on the cloudf, protected from loss or damage.",
    icon: ServerCogIcon,
  },
  {
    id: 6,
        ...
        <div className="relative overflow-hidden pt-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div aria-hidden="true" className="relative">
              <div className="absolute bottom-0 -inset-x-32
          ...
          <dl className="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-10 text-base leading-7 text-gray-600 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3 lg:gap-x-8 lg:gap-y-16">
            {features.map(feature => (
              <div key={feature.id}className="relative pl-9">
                ...
                <dd><div className="font-semibold text-indigo-600">{feature.name}</div>{feature.description}</dd>
              </div>
            ))}
          </dl>
        </div>
